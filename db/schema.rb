...
ActiveRecord::Schema.define(version: 2019_06_29_180507) do
  ...
  create_table "telegram_link_tokens", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "value"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_telegram_link_tokens_on_user_id"
  end
  ...
  add_foreign_key "telegram_link_tokens", "users"
end
